...
(function (g, e, b, j, c, i, k) {/*! Jssor */
    ...
    var a = new function () {
        var f = this, zb = /\S+/g, S = 1, fb = 2, jb = 3, ib = 4, nb = 5, I, s = 0, l = 0, q = 0, J = 0, C = 0, y = navigator, sb = y.appName, n = y.userAgent;

        function Ib() {
            if (!I) {
                I = {Rg: "ontouchstart" in g || "createTouch" in e};
                var a;
        ...
        f.jg = function (b, a) {
            if (ab()) vb(f.K(j, Z, b, a)); else(L() ? Bb : Z)(b, a)
        };
        ...
        var Q = {$Opacity: f.Ab, $Top: f.G, $Left: f.E, N: f.l, P: f.m, Bb: f.z, Kh: f.Y, $ZIndex: f.J}, K;

        function G() {
            if (!K) K = z({Mh: f.Dd, Lh: f.Id, $Clip: f.pg, B: f.jg}, Q);
            return K
        }
        ...
        f.Lc = function (b) {
            var c = b || {};
            if (b)if (a.fd(b)) c = {kb: c}; else if (a.fd(b.$Clip)) c.$Clip = {kb: b.$Clip};
            return c
        };
        function tb(c, a) {
            var b = {};
            m(c, function (c, d) {
                var e = c;
                if (a[d] != k)if (f.Zb(c)) e = c + a[d]; else e = tb(c, a[d]);
                b[d] = e
            });
            return b
        }
        ...
        f.Kd = function (h, i, w, n, y, z, o) {
            ...
            if (h) {
                ...
                for (var g in i) {
                    ...
                    var u = b.floor(e);
                    if (e != u) e -= u;
                    var l = n.kb || d.$EaseSwing, m, B = h[g], q = i[g];
                    if (a.Zb(q)) {
                        l = n[g] || l;
                        var x = l(e);
                        m = B + q * x
    ...
    var l = function (y, C, k, P, N, J) {
        y = y || 0;
        var d = this, q, n, o, v, z = 0, H, I, G, B, x = 0, h = 0, m = 0, D, l, f, e, p, w = [], A;
    ...
    var o = g.$JssorSlideshowFormations$ = new function () {
        ...
        h.$FormationStraight = function (f) {
            for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.hc, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++)for (a = 0; a < d; a++) {
                switch (s) {
                    case j:
                        c = h - (a * e + (q - b));
                        break;
        ...
        h.$FormationSwirl = function (q) {
            var x = q.$Cols, y = q.$Rows, B = q.$Assembly, w = q.hc, A = [], z = [], u = 0, b = 0, h = 0, r = x - 1, s = y - 1, t, p, v = 0;
            switch (B) {
                case j:
                    b = r;
                    h = 0;
        ...
        h.$FormationZigZag = function (p) {
            var w = p.$Cols, x = p.$Rows, z = p.$Assembly, v = p.hc, t = [], u = 0, b = 0, c = 0, q = w - 1, r = x - 1, y, h, s = 0;
            switch (z) {
                case j:
                    b = q;
                    c = 0;
    ...
    g.$JssorSlideshowRunner$ = function (n, s, q, t, y) {
        ...
        function p(A, h, d, v, n, l) {
            var y = this, t, u = {}, j = {}, m = [], f, e, r, p = d.$ChessMode.$Column || 0, q = d.$ChessMode.$Row || 0, g = d.ie(n, l), o = B(d), C = o.length - 1, s = d.$Duration + d.$Delay * C, w = v + s, k = d.$SlideOut, x;
            w += 50;
            function B(a) {
                var b = a.$Formation(a);
            ...
            y.Vb = function (c) {
                ...
                if (e || x) {
                    ...
                    a.c(j, function (c, e) {
                        ...
                        if (c.Rc != d) {
                            if (!c.Rc && !k) a.A(m[e]); else d == c.me && k && a.S(m[e]);
                            c.Rc = d;
                            a.Wd(m[e], c[d])
                        }
                    })
            ...
            a.c(o, function (h, m) {
                a.c(h, function (G) {
                    ...
                    d.$Clip = C || z || B || A;
                    r = {};
                    e = {$Top: 0, $Left: 0, $Opacity: 1, N: n, P: l};
                    f = a.p({}, e);
                    t = a.p({}, g[v]);
                    ...
                    if (d.$Zoom || d.$Rotate) {
                        var H = c;
                        if (a.V())if (d.$Cols * d.$Rows > 1) H = i; else I = i;
                        if (H) {
                    ...
                    if (I) {
                        ...
                        if (d.$Clip) {
                            ...
                            if (B && A) {
                                h.$Left = g.N / 2 * w;
                                h.$Right = -h.$Left
                            } else if (B) h.$Right = -g.N * w; else if (A) h.$Left = g.N * w
                        }
                        r.$Clip = t;
                        f.$Clip = g[v]
                    }
    ...
    var h = g.$JssorSlider$ = function (q, fc) {
        ...
        function Cc() {
            ...
            l.call(a, -1, 2, {$Easing: d.$EaseLinear, xc: {Bb: Zb}, Tc: r}, b, {Bb: 1}, {Bb: -2});
            a.Mb = b
        }

        function qc(n, m) {
            var a = this, d, e, g, k, b;
            l.call(a, -1e8, 2e8, {Uc: 100});
            a.Od = function () {
                O = c;
                R = j;
        ...
        function Bc(k, e) {
            var d = this, q, H, x, n, y = [], w, B, W, G, Q, F, g, v, p;
            l.call(d, -u, u + 1, {});
            function E(b) {
                q && q.jb();
                T(k, b, 0);
            ...
            function ab(b) {
                if (b == R && s == e) {
                    if (!g) {
                        var a = j;
                        if (A)if (A.nb == e) a = A.de(); else A.Db();
                        Y();
                        g = new yc(k, e, a, q);
                        g.gd(p)
                    }
            ...
            function S(c, h, l) {
                if (c == e) {
                    if (c != h) C[h] && C[h].Be(); else!l && g && g.Le();
                    p && p.$Enable();
                    var m = R = a.T();
                    d.Cb(a.K(j, ab, m))
                } else {
            ...
            function T(b, d, e) {
                ...
                a.c(f, function (f) {
                    ...
                    if (j == "player" && !v) {
                        v = f;
                        if (v.pInstance) O(); else a.e(v, "dataavailable", O)
                    }
                    if (j == "caption") {
                        if (d) {
                            a.Sc(f, a.j(f, "to"));
                        ...
                        if (h == "A") {
                            if (a.j(f, "u") == "image") n = a.xg(f, "IMG"); else n = a.D(f, "image", c);
                            if (n) {
                                w = f;
                                a.Y(w, "block");
                                a.bb(w, V);
        ...
        function yc(y, f, p, q) {
            ...
            b.wc = function () {
                ...
                if (!B && !O && !r && s == f) {
                    ...
                    if (a != d)if (a == e) i = d; else if (a == j) i = e; else if (!a) i = j; else i = b.Sd();
                    o.n(p, f, a, m, j, e, d);
                    var l = P && (!E || F);
                    if (a == d) (e != d && !(E & 12) || l) && n.ze(); else(l || a != e) && b.Cd(i, w)
                }
            };
            b.Le = function () {
                e == d && e == b.yb() && b.v(j)
        ...
        var gb = f.$PlayOrientation & 3, wc = (f.$PlayOrientation & 4) / -4 || 1, db = f.$SlideshowOptions, I = a.p({
            $Class: p,
            $PlayInMode: 1,
            $PlayOutMode: 1
        }, f.$CaptionSliderOptions);
        I.$Transitions = I.$Transitions || I.$CaptionTransitions;
        var qb = f.$BulletNavigatorOptions, W = f.$ArrowNavigatorOptions, ab = f.$ThumbnailNavigatorOptions, Q = !f.$UISearchMode, y, v = a.D(q, "slides", Q), cb = a.D(q, "loading", Q) || a.mb(e), Jb = a.D(q, "navigator", Q), cc = a.D(q, "arrowleft", Q), ac = a.D(q, "arrowright", Q), Hb = a.D(q, "thumbnavigator", Q), nc = a.l(v), mc = a.m(v), V, T = [], xc = a.O(v);
        a.c(xc, function (b) {
            if (b.tagName == "DIV" && !a.j(b, "u")) T.push(b); else a.V() && a.J(b, (a.J(b) || 0) + 1)
        });
        ...
        var xb = v, C = [], A, N, Fb = a.Pg(), jb = Fb.Rg, G, pb, Kb, sb;
    ...
    g.$JssorBulletNavigator$ = function (e, C) {
        ...
        f.Jb = d = a.p({$SpacingX: 10, $SpacingY: 10, $Orientation: 1, $ActionMode: 1}, C);
        g = a.D(e, "prototype");
        q = a.l(g);
        p = a.m(g);
        a.Hb(g, e);
    ...
    g.$JssorThumbnailNavigator$ = function (g, C) {
        ...
        l.Jb = d = a.p({$SpacingX: 0, $SpacingY: 0, $Cols: 1, $Orientation: 1, $AutoCenter: 3, $ActionMode: 1}, C);
    ...
    g.$JssorCaptionSlider$ = function (h, f, i) {
        ...
        function g(p, h, f) {
            var c = this, g, n = f ? h.$PlayInMode : h.$PlayOutMode, e = h.$Transitions, o = {
                ...
                kb: function (b, a) {
                    if (!isNaN(a.sb)) b = a.sb; else b *= a.Kf;
                    return b
            ...
            function j(r, m) {
                ...
                function h(c, d) {
                    ...
                    a.c(o, function (g, h) {
                        ...
                        if (e) {
                            var f = {};
                            if (g == "t") f.sb = e; else if (e.indexOf("%") + 1) f.Kf = a.Nc(e) / 100; else f.sb = a.Nc(e);
                            b[h] = f
                        }
                    });
                    return b
                        ...
                        if (e) {
                            ...
                            if (f && f.ab) {
                                ...
                                if (k) {
                                    ...
                                    if (!o)if (f.Gb) i.Gb = f.Gb.sb || 0; else if (n & 2) i.Gb = 0
                                }
                            }
                            c.push(i)
                        }
            ...
            function m(w, c, z) {
                ...
                if (c.$Zoom || c.$Rotate) {
                    ...
                    var s = {
                        ...
                        $Bottom: j,
                        $Left: 0
                    }, v = a.p({}, s), d = v.wb = {}, u = c.$Clip & 4, p = c.$Clip & 8, t = c.$Clip & 1, q = c.$Clip & 2;
                    if (u && p) {
                        d.$Top = j / 2 * i;
                        d.$Bottom = -d.$Top
    ...
    g.$JssorCaptionSlideo$ = function (n, g, m) {
        ...
        function j(d, c) {
            ...
            a.c(d, function (d, f) {
                var e = h[f];
                if (e) {
                    if (a.yg(d)) d = j(d, c || f == "e"); else if (c)if (a.Zb(d)) d = o[d];
                    b[e] = d
                }
            });
            return b
        ...
        function k(e, c) {
            ...
            a.c(d, function (d) {
                ...
                if (h) {
                    var e = a.j(d, "t"), g = i[a.Kb(e)] || i[e], f = {$Elmt: d, ab: g};
                    b.push(f)
                }
