...
<div id="r-result2"></div>
    <div id="gj_way">
        <h3 style="margin-top: 0px;">成都公交查询</h3>
        <input placeholder="起点" type="text" class="form-control" name="start2" id="start2" value=""><br/>
        <input placeholder="终点"  type="text" class="form-control" name="end2" id="end2" value=""></div><br/>
        <input type="button" class="btn btn-info btn-block" id="result2" value="查询" style="height: 50px;">
...
<script type="text/javascript">
    ...
    cr.addCopyright({id: 1, content: "<p style='font-size:18px;background:#cbd2e2;'>苍溪发布</p>", bounds: bs});
    /*新添加版权信息*/
